...
def main():
    """
    Main function to accept user input and compute results for part 1 and part 2.
    """
    print("Enter the grid (one row per line). End input with an empty line:")
    input_array = []
    for i in range(0,141):
        s=input()
        input_array.append(s)

    part1_result = aoc2024_day20_part1(input_array)
    part2_result = aoc2024_day20_part2(input_array)
